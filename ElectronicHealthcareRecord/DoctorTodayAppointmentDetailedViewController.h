//
//  DoctorViewDetailedAppointmentViewController.h
...
@interface DoctorTodayAppointmentDetailedViewController : UIViewController
...
@property(nonatomic,retain)IBOutlet UIButton *reshedule;
