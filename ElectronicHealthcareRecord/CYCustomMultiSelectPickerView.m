...
- (void)pickerShow
{
  //  entries = [[NSArray alloc] initWithObjects:@"Row 1", @"Row 2", @"Row 3", @"Row 4", @"Row 5", nil];
    ...
    if (!self.pickerView) {
        self.pickerView = [[[ALPickerView alloc] initWithFrame:CGRectMake(0,260, 755, 260)] autorelease];
    }
	...
	UIBarButtonItem *confirmBtn = [[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStyleDone target:self action:@selector(confirmPickView)];
    ...
    if (self.toolBar==nil) {
        self.toolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, self.pickerView.frame.origin.y - 44, 755, 44)];
    }
    ...
    [UIView animateWithDuration:0.5 animations:^{
        self.pickerView.frame = CGRectMake(0, 44, 755, 260);
        self.toolBar.frame = CGRectMake(0, self.pickerView.frame.origin.y-44, 755, 44);
    }];
...
- (void)pickerHide
{
    [UIView animateWithDuration:0.5 animations:^{
        self.alpha = 0.0;
        self.pickerView.frame = CGRectMake(0, 260+44, 755, 260);
        self.toolBar.frame = CGRectMake(0, self.pickerView.frame.origin.y-44, 755, 44);
    }];
}
