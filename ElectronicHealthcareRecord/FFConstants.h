...
//Changed the below two lines to set timeslot with custom interval
#define HEIGHT_CELL_MIN 60          //To set width of cell between timeslots
#define MINUTES_PER_LABEL 60./4    //Change it for custom interval
