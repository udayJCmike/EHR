...
#import "Clinic_View_AppointmentsViewController.h"
#import "Clinic_Detail_View_AppointmentsViewController.h"
#import "Clinic_View_AppointmentsViewController.h"
#import "Clinic_View_Appointments_Table_CellViewController.h"

@interface Clinic_View_AppointmentsViewController ()

@end

@implementation Clinic_View_AppointmentsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Clinic_View_Appointments_Table_CellViewController *cell = (Clinic_View_Appointments_Table_CellViewController*)[self.view_appointments dequeueReusableCellWithIdentifier:@"view_appointments" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier:@"detailviewappointments" sender:self];
