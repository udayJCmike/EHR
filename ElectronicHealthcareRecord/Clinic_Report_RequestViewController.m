...
#import "Clinic_Report_RequestViewController.h"
#import "Clinic_Report_Table_CellViewController.h"
#import "Clinic_Detail_Report_RequestViewController.h"

@interface Clinic_Report_RequestViewController ()

@end

@implementation Clinic_Report_RequestViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Clinic_Report_Table_CellViewController *cell = (Clinic_Report_Table_CellViewController*)[self.view_appointments dequeueReusableCellWithIdentifier:@"report" forIndexPath:indexPath];
