...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setTitleColor:[UIColor colorWithRed:79 green:192 blue:255 alpha:1] forState:UIControlStateNormal];
        ...
        [self.layer setBorderColor:[UIColor colorWithRed:79 green:192 blue:255 alpha:1].CGColor];
